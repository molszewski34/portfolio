  ...
  <Layout>
    <main className="flex flex-col justify-center items-center">
      ...
      <section className="flex flex-col justify-center  mb-10">
        ...
        <div
          className="markdown flex flex-col justify-center mb-5"
          dangerouslySetInnerHTML={{ __html: data.text.html }}
        ></div>
        <div className="mt-5">
          <Link className="" to={data.githubLink} key={data.githubLink}>
            <button className="bg-gray-500 text-white p-3 font-semibold flex  gap-1 rounded-md hover:bg-opacity-80">
              Code
              <FontAwesomeIcon

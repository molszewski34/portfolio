...
Portfolio is a project made in Gatsbyjs to present latest projects.

**Features.**
Projects from repositories presented with programaticaly made pages.

**Stack**
React, Gatsbyjs, GraphCms, Tailwind

This portfolio was made with use of Gatsbyjs and React.
